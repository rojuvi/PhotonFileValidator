...
public class RemoveIslandsDialog extends JDialog {
    ...
    private JButton removeSmallButton;
    ...
    public RemoveIslandsDialog(final MainForm mainForm) {
        ...
        removeAllButton.addActionListener(e -> {
            int removeAllIslands = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete ALL islands?\nThis will remove islands on every layer.", "Remove all islands", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
            if (removeAllIslands == 0) {
                PhotonIslandRemovalWorker photonIslandRemovalWorker = new PhotonIslandRemovalWorker(mainForm, that, photonFile);
    ...
    public void activate() {
        ...
        if (!photonFile.getMultiLayerIslands().isEmpty()) {
        ...
        if (anyOneLayerIsland()) {
            removeSmallButton.setEnabled(true);
        } else {
            removeSmallButton.setEnabled(false);
        }
        contentPane.repaint();
    }
    ...
    private boolean anyOneLayerIsland() {
        // TODO
        return false;
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        contentPane.setMinimumSize(new Dimension(1024, 600));
        ...
        contentPane.add(panel3, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(1024, 600), new Dimension(2147483647, 2147483647), 0, false));
        ...
        panel7.add(removeSelectedButton, new GridConstraints(0, 4, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel7.add(removeAllButton, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        removeSmallButton = new JButton();
        removeSmallButton.setEnabled(false);
        removeSmallButton.setText("Remove One Layer Islands");
        panel7.add(removeSmallButton, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        progressBar = new JProgressBar();
        progressBar.setMinimum(-1);
        progressBar.setStringPainted(false);
        progressBar.setValue(-1);
        panel6.add(progressBar, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
